...
// Conversores de string
	   ...
	   std::string token(int e) {
		   ...
		   case 105: return "Operador de suma \n";
		   case 106: return "Operador de resta \n";
		   case 107: return "Operador de multiplicacion \n";
		   case 108: return "Operador de division \n";
		   ...
		   case 125: return "Caracter constante \n";
